...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    ...
    | `/dashboard/contests/${SafeSlug<T>}`
    | `/dashboard/contests/${SafeSlug<T>}/edit`
    | `/dashboard/contests/${SafeSlug<T>}/judges`
    | `/dashboard/contests/${SafeSlug<T>}/submissions`
    | `/invite/${SafeSlug<T>}`
    | `/judging/${SafeSlug<T>}`
    | `/judging/${SafeSlug<T>}/${SafeSlug<T>}`
    | `/news/${SafeSlug<T>}`
