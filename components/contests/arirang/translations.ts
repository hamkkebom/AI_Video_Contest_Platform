...
export const translations = {
  ...
  schedule: {
    ...
    eventApplyDate: { ko: '2026. 2. 25(수) ~ 4. 4(토)', en: '2026. 2. 25(수) ~ 4. 4(토)' },
    eventJudgingTitle: { ko: '심사 기간', en: 'Judging Period' },
    eventJudgingDate: { ko: '2026. 4. 6(월) ~ 4. 24(금)', en: '2026. 4. 6(월) ~ 4. 24(금)' },
    eventAwardTitle: { ko: '결과 발표', en: 'Results Announcement' },
    eventAwardDate: { ko: '2026. 4. 25(토)', en: '2026. 4. 25(토)' },
  ...
  prizes: {
    ...
    criteriaVoteDesc: { ko: '오프라인 전시 현장 QR코드를 통한 온라인 투표', en: 'Online voting via QR code at offline exhibition' },
  ...
  apply: {
    ...
    deadlineValue: { ko: '2026년 4월 4일 (토) 23:59', en: '2026년 4월 4일 (토) 23:59' },
