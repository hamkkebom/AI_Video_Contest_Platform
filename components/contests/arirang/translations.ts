...
export const translations = {
  ...
  notes: {
    ...
    copyrightTitle: { ko: '권리 귀속', en: 'Ownership of Rights' },
    copyrightDesc: { ko: '출품작의 저작권은 제작자에게 있습니다. 단, 수상작에 한하여 저작권은 함께봄과 제작자가 각 50%씩 공동 소유합니다.', en: 'Copyright of submitted works belongs to the creator. For winning works, however, copyright is co-owned 50:50 by Hamkkebom and the creator.' },
    copyrightNote: { ko: '향후 AI콘텐츠저작권협회 설립 시 제작자에게 100% 양도 가능', en: 'If an AI Content Copyright Association is established in the future, rights may be fully transferred to the creator.' },
    usageTitle: { ko: '사용권', en: 'Usage Rights' },
    usageDesc: { ko: '출품작에 대한 사용권 및 2차적 저작물 작성권은 함께봄에 100% 귀속되며, 마케팅 및 홍보 목적으로 활용될 수 있습니다.', en: 'Usage rights and rights to create derivative works from submissions belong 100% to Hamkkebom and may be used for marketing and promotion.' },
    commercialTitle: { ko: '상업적 이용 보장', en: 'Commercial Usability Required' },
    commercialDesc: { ko: '응모자는 AI툴로 제작된 결과물이 상업적 이용에 결격 사유가 없는 결과물이어야 합니다.', en: 'Entrants must ensure that AI-generated results are eligible for commercial use without disqualifying restrictions.' },
    legalTitle: { ko: '법적 책임', en: 'Legal Responsibility' },
    legalDesc: { ko: '모든 출품작은 제3자의 저작권, 초상권 등을 침해하지 않는 순수 창작물이어야 하며, 문제 발생 시 모든 책임은 출품자에게 있습니다.', en: 'All submissions must be original works that do not infringe third-party rights such as copyright or portrait rights. Any resulting liability rests with the entrant.' },
    duplicateTitle: { ko: '중복 참여 및 팀 참여 불가', en: 'No Duplicate or Team Entries' },
    duplicateDesc: { ko: '1인당 1회 응모 가능하며, 팀으로 작업한 사실이 밝혀질 경우 수상은 취소될 수 있습니다.', en: 'Each person may submit only one entry. If team production is discovered, the award may be revoked.' },
    disqualificationTitle: { ko: '즉시 실격 처리 대상', en: 'Immediate Disqualification' },
    disqualificationDesc: { ko: '선정적, 차별적, 폭력적 내용 등이 포함된 작품은 즉시 실격 처리됩니다.', en: 'Works containing explicit, discriminatory, or violent content will be disqualified immediately.' },
    promotionTitle: { ko: '작품 활용 안내', en: 'How Submitted Works May Be Used' },
    promotionDesc: { ko: '제출된 작품은 행사 홍보·연출에 활용될 수 있습니다.', en: 'Submitted works may be used for event promotion and presentation.' },
    aiRequiredTitle: { ko: 'AI 창작물 필수', en: 'AI-Created Work Required' },
    aiRequiredDesc: { ko: '제출 작품은 반드시 AI 활용 창작물이어야 하며, 저작권·초상권 문제 발생 시 실격 처리될 수 있습니다.', en: 'Submissions must be AI-assisted creative works. Entries may be disqualified if copyright or portrait-right issues arise.' },
    publicVoteTitle: { ko: '대중 평가 반영', en: 'Public Evaluation Reflected' },
    publicVoteDesc: { ko: '제출된 작품은 함께봄 공모전 페이지에 게시되며, 좋아요 수 등 대중평가 점수가 심사에 반영됩니다.', en: 'Submitted works will be posted on the Hamkkebom contest page, and public metrics such as likes will be reflected in judging.' },
  },
  footer: {
    title: { ko: '꿈꾸는 아리랑', en: 'Dreaming Arirang' },
