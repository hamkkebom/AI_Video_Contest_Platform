...
const events = [
  ...
  { icon: ClipboardCheck, titleKey: 'eventJudgingTitle', dateKey: 'eventJudgingDate', color: 'var(--ar-pine-light)', active: false },
  { icon: Trophy, titleKey: 'eventAwardTitle', dateKey: 'eventAwardDate', color: 'var(--ar-point)', active: false },
];
    ...
    <section id="schedule" className="relative py-24 md:py-32" style={{ backgroundColor: 'var(--ar-primary-dark)' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* 연결선 (데스크톱) */}
          <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-0.5" style={{ backgroundColor: 'rgba(245,240,232,0.1)' }} />
