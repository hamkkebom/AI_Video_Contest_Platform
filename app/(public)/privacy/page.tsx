...
const sections = [
  ...
  { id: 'privacy-5', title: '5. 파기 절차 및 방법' },
  { id: 'privacy-6', title: '6. 보호 책임자' },
];
    ...
    <div className="w-full">
      ...
      <section className="py-12 px-4 bg-gradient-to-b from-primary/5 to-background border-b border-border">
        <div className="container mx-auto max-w-5xl">
          ...
          <Badge variant="outline" className="text-xs">최종 수정일: 2026년 2월 20일</Badge>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="flex gap-8">
            ...
            <div className="flex-1 space-y-6">
              ...
              <Card id="privacy-6">
                <CardContent className="pt-6">
                  <h2 className="text-lg font-semibold mb-3">6. 개인정보 보호 책임자</h2>
                  <p className="text-muted-foreground leading-relaxed">
                  ...
                  <div className="mt-4 p-4 bg-muted/30 rounded-lg border border-border">
                    <p className="text-sm text-muted-foreground mb-2">개인정보 보호 책임자</p>
                    <p className="text-sm font-medium">이메일: privacy@hamkkebom.kr</p>
              ...
              <div className="border-t border-border pt-6 mt-6">
                <p className="text-sm text-muted-foreground">본 개인정보처리방침은 2026년 2월 20일부터 시행됩니다.</p>
              </div>
            </div>
          </div>
        </div>
