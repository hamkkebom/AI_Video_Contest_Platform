export default function ColorBPage() {
    ...
    <main style={{ padding: "40px 20px", background: "#f5f5f5", minHeight: "100vh" }}>
      ...
      >
        ...
        <p style={{ fontSize: 16, margin: "0 0 24px", opacity: 0.95 }}>
          <strong>Color Scheme B: Deep Purple AI</strong>
        </p>
      ...
      >
        ...
        <ul style={{ color: "#666", lineHeight: 1.8, fontSize: 14 }}>
          <li>🟣 Primary Color: 고급스럽고 신비로운 딥 퍼플</li>
          <li>💜 Secondary Color: 창의적이고 예술적인 핫 핑크</li>
          <li>🟢 Accent Color: 신선하고 긍정적인 그린으로 포인트에 사용</li>
          <li>✨ 분위기: 프리미엄, 창의력, 예술성, 혁신의 이미지</li>
        </ul>
      </section>
    </main>
  );
