...
export default function PricingPage() {
  ...
  const pricingPlans = {
    participant: {
      name: '참가자 플랜',
      description: '공모전 출품 및 갤러리 활동을 위한 플랜',
      price: 9900,
      period: '월',
      features: [
    ...
    host: {
      name: '주최자 플랜',
      description: '공모전 개최 및 관리를 위한 전문 플랜',
      price: 29900,
      period: '월',
      features: [
    ...
    judge: {
      name: '심사위원 플랜',
      description: '공모전 심사 및 채점을 위한 플랜',
      price: 0,
      period: '무료',
      features: [
            ...
            <CardContent>
              ...
              <div className="mb-8 pb-6 border-b border-border">
                <div className="flex items-baseline gap-2">
                  ...
                  {activeTab !== 'judge' && (
                    <span className="text-muted-foreground text-lg">원 / {currentPlan.period}</span>
                  )}
                </div>
              </div>
