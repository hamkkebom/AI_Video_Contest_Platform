export default function ColorCPage() {
    ...
    <main style={{ padding: "40px 20px", background: "#f5f5f5", minHeight: "100vh" }}>
      ...
      >
        ...
        <p style={{ fontSize: 16, margin: "0 0 24px", opacity: 0.95 }}>
          <strong>Color Scheme C: Warm Earth</strong>
        </p>
      ...
      >
        ...
        <ul style={{ color: "#666", lineHeight: 1.8, fontSize: 14 }}>
          <li>🟠 Primary Color: 따뜻하고 생동감 있는 주황색</li>
          <li>🟡 Secondary Color: 쾌활하고 신뢰할 수 있는 앰버</li>
          <li>🟣 Accent Color: 미묘하고 전문적인 보라색</li>
          <li>✨ 분위기: 따뜻함, 접근성, 신뢰, 친근함의 이미지</li>
        </ul>
      </section>
    </main>
  );
